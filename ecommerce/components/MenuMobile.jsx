...
const MenuMobile = ({showCatMenu ,setShowCatMenu, setMobileMenu }) => { 
  ...
  return (
    <ul className='md:hidden flex flex-col gap-4 font-medium text-gray-600 absolute top-[50px] left-0 w-full h-[calc(100vh-50px)] bg-white border-t text-black'> {/* Changed class to hide on md breakpoint */}
        {data.map((item) => (
